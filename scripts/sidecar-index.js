...
const TOKEN = process.env.SIDECAR_TOKEN || process.env.WHATSAPP_WEB_TOKEN || '';
const defaultSessionDir = path.resolve(__dirname, '../../../../storage/app/whatsapp-sidecar/sessions');
const SESSION_DIR =
  process.env.SESSION_DIR ||
  process.env.WHATSAPP_WEB_SESSION_DIR ||
  (fs.existsSync(path.resolve(__dirname, '../../../../storage')) ? defaultSessionDir : path.join(__dirname, 'sessions'));
